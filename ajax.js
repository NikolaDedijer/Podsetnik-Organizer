function doInsert() {
    ...
    ajax.send("fname=" + a + "&tname=" + b + "&dname=" + c + "&gname=" + d + "&cell5=" + e + "&do_insert=1");
    return false;
}
...
ajax.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
        ...
        for (var a = 0; a < data.length; a++) {
            ...
            cell6.innerHTML = '<span style="cursor: pointer;" id="boja" class="fas fa-check fa-border fa-1x"></span>';
